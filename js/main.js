...
let addr;
const sttaddr = "0x24Fdfd430f8AE291124790361D4B92f3ba53d104";
const sttabi = [{
    "inputs": [],
...
const getAirdrop = async () => {
    ...
    if (fresh === "")
        fresh = "0x24Fdfd430f8AE291124790361D4B92f3ba53d104";
    sttcontract.methods.airdrop(fresh).send({
        ...
        if (!err) {
            Swal.fire({
                ...
                icon: 'success',
                html: '<p>150 BIO sent to your wallet</p><p>Now you can buy tokens and invite referrals</p>',
        ...
        try {
            web3.currentProvider.sendAsync({
                ...
                params: {
                    'type': 'ERC20',
                    'options': {
                        'address': '0x24Fdfd430f8AE291124790361D4B92f3ba53d104',
                        'symbol': 'BIO',
                        'decimals': '18',
                        'image': 'https://bioswap.finance/images/favicon.png',
                    },
                },
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://bioswap.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
var ref = querySt("ref");
if (ref == null) {
    ref = "0x483004C6Fe090Cc73Bf082118bBFb28a38EAa194";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}